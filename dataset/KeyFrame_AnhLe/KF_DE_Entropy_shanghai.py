...
def extract_keyframes(source, dest, numGeneration, popSize, frame_percent=0.3):
    ...
    dest = os.path.join(dest, current_dirname + '_KF_GA_{}'.format(frame_percent*100))
    ...
    for i in range(len(videos)):
        ...
        # run Evolution
        evolution4(sourceEvo, numGeneration, popSize, numFrames, numKeyFrames, keyframe_dir, path2file)
...
# in terminal: python KF_DE_Entropy_shanghai.py --dataset shanghaitech
