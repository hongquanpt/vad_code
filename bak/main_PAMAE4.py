...
from bak.model.MNAD.PAMAEModel4 import PAMAEModel4
...
def train(cfg, device, logger, writer, checkpoint_dir_path):
    ...
    # ====================================
    # 4. load model
    pamae4 = PAMAEModel4(cfg, device, logger, writer)
    ...
    pamae4.train(train_dataloader, train_dataloader_sf, checkpoint_filepath, checkpoint_dir_path)
    return 1
...
def test(cfg, device, logger, writer, visualization_dir_path):
    ...
    pamae4.test(test_dataloader, label_list, checkpoint_filepath, sub_visualization_dir_path)
    return 0
...
if __name__ == '__main__':
    """
    python main_PAMAE4.py --phase 'train' --dataset 'ped2' SYSTEM.device 'cuda:0'
    python main_PAMAE4.py --phase 'test' --dataset 'ped2' SYSTEM.device 'cuda:0' TEST.dir_name 'session_2023_12_25_23_36_60'
    """
    main(net='PAMAE4')
