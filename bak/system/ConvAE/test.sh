...
# step 1: chmod u+x system/ConvAE/test.sh
# step 2: ./system/ConvAE/test.sh
...
config_filepath='system/ConvAE/ped2-ConvAE_SVM.yaml'
...
echo ">>> main_ConvAE.py >>>>"
python main_ConvAE.py --cfgfile "$config_filepath" SYSTEM.phase 'test'
