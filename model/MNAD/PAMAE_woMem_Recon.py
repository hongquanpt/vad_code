...
class PAMAE_woMem_Recon(torch.nn.Module):
    def __init__(self, num_channels =3,  num_frames = 1):
        super(PAMAE_woMem_Recon, self).__init__()

        self.encoder = Encoder(num_frames, num_channels)
        self.decoder = Decoder(num_frames, num_channels)
