import argparse
from system.VideoVAE.default import update_config, cfg # for MNAD
...
from model.VideoVAEModel import VideoVAEModel
...
def train(cfg, device, logger, writer, checkpoint_dirpath):
    ...
    #====================================
    videovae = VideoVAEModel(cfg, device, logger, writer)
    videovae.train(train_dataloader, checkpoint_dirpath)
    return 1
...
def parse_args():
    ...
    cfg_filename = 'system/VideoVAE/ped2.yaml'
