...
cfg.DATASET.clip_mode = 'list' # cat, stack, list
...
#===============================
cfg.TRAIN = CN()
cfg.TRAIN.name = 'ConvVRNN_trainer'
...
cfg.TRAIN.other_params.lamda = 0.5
...
#===============================
cfg.TEST = CN()
cfg.TEST.name = 'ConvVRNN_tester'
cfg.TEST.checkpoint_filepaths =  ['final_checkpoint_1.pth', 'final_checkpoint_2.pth']
cfg.TEST.ocsvm_filepaths =  ['ocsvm_1.pkl', 'ocsvm_2.pkl']
cfg.TEST.other_params = CN()
cfg.TEST.other_params.nu = [0.1, 0.5, 0.9]
