...
# step 1: chmod u+x system/ConvVRNN/train.sh
# step 2: ./system/ConvVRNN/train.sh
...
config_filepath='system/ConvVRNN/ped2.yaml' # avenue.yaml, shanghaitech.yaml
#loop=(1 2 3 4 5)
loop=(1)
...
for id in "${loop[@]}"; do
    ...
    python main_ConvVRNN.py --cfgfile "$config_filepath" SYSTEM.phase 'train' SYSTEM.loop_index "$id"
done
conda deactivate