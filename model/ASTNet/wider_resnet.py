...
class IdentityResidualBlock(nn.Module):
    ...
    def __init__(self,
        ...
        """cfgurable identity-mapping residual block
...
class wrn38(nn.Module):
    ...
    def __init__(self, cfg, pretrained=True):
        ...
        if pretrained:
            pretrained_model = cfg.TRAIN.other_params.pretrained_seg_weights
...
def wresnet(cfg, name, pretrained=True):
    if name == 'wrn38':
        return wrn38(cfg, pretrained=pretrained)
    elif name == 'wrn20':
        return wrn20(cfg, pretrained=pretrained)
    elif name == 'wrn38_layer6':
        return wrn38_layer6(cfg, pretrained=pretrained)
    elif name == 'wrn38_layer5':
        return wrn38_layer5(cfg, pretrained=pretrained)
    else:
