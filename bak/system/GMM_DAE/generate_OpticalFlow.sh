...
# step 1: chmod u+x system/GMM_DAE/generate_OpticalFlow.sh
# step 2: ./system/GMM_DAE/generate_OpticalFlow.sh
...
python main_GMM_DAE.py --cfgfile "$config_filepath" SYSTEM.phase 'generate_OpticalFlow' SYSTEM.device "cuda:0"
