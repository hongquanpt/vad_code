...
from VAD.libs.flownet_networks.resample2d_package.resample2d import Resample2d
from VAD.libs.flownet_networks.channelnorm_package.channelnorm import ChannelNorm

from VAD.libs.flownet_networks import FlowNetC
from VAD.libs.flownet_networks import FlowNetS
from VAD.libs.flownet_networks import FlowNetSD
from VAD.libs.flownet_networks import FlowNetFusion

from VAD.libs.flownet_networks.submodules import *
...
class FlowNet2(nn.Module):
    ...
    def forward(self, inputs):
        # 输入的范围是【0-255】 shape 是 【bs,img_3,2,H,W】
        # The input range is [0-255] shape is [bs,img_3,2,H,W]
...
class FlowNet2C(FlowNetC.FlowNetC):
    def __init__(self, rgb_max=255.0, fp16=False, batchNorm=False, div_flow=20):
        super(FlowNet2C, self).__init__(fp16=fp16, batchNorm=batchNorm, div_flow=20)
        self.rgb_max = rgb_max
...
class FlowNet2S(FlowNetS.FlowNetS):
    def __init__(self, rgb_max=255.0, batchNorm=False, div_flow=20):
