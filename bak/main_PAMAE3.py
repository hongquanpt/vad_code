...
from dataset.process import get_train_dataset_aug, get_test_dataset
from dataset.label import LabelVideoDataset
from bak.model.MNAD.PAMAEModel3 import PAMAEModel3
...
def train(cfg, device, logger, writer, checkpoint_dir_path):
    ...
    # ====================================
    # 5. load model
    pamae3 = PAMAEModel3(cfg, device, logger, writer)
    ...
    pamae3.train(train_dataloader, checkpoint_filepath, checkpoint_dir_path)
    return 1
...
def test(cfg, device, logger, writer, visualization_dir_path):
    ...
    pamae3.test(test_dataloader, label_list, checkpoint_filepath, sub_visualization_dir_path)
    return 0
...
if __name__ == '__main__':
    """
    python main_PAMAE3.py --phase 'train' --dataset 'ped2' SYSTEM.device "cuda:0"
    python main_PAMAE3.py --phase 'test' --dataset 'ped2' SYSTEM.device "cuda:0"
    """
    main(net='PAMAE3')
