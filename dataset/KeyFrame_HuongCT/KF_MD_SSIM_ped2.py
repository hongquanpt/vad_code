...
def extract_keyframes(source, dest):
    ...
    dest = os.path.join(dest, current_dirname + '_keyframes_medium_SSIM')
...
def main_extract_keyframes():
    ...
    parser.add_argument('--source', type=str, default='ped2/training', help='source file')
    parser.add_argument('--dest', type=str, default='ped2', help='destination folder')
