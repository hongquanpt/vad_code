...
from .wider_resnet import wresnet
from .basic_modules import ConvBnRelu, ConvTransposeBnRelu, initialize_weights
...
class ASTNet(nn.Module):
    ...
    def __init__(self, cfg, pretrained=True):
        ...
        frames = cfg.TRAIN.other_params.encoded_frames
        final_conv_kernel = cfg.TRAIN.other_params.final_conv_kernel
        self.model_name = cfg.TRAIN.other_params.pretrained_model

        logger.info('=> ' + self.model_name + '_1024: (CATTN + TSM) - Ped2')

        self.wrn38 = wresnet(cfg, self.model_name, pretrained=pretrained)  # wrn38(cfg, pretrained=True)
