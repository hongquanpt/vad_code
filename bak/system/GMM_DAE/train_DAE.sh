...
# step 1: chmod u+x system/GMM_DAE/train_DAE.sh
# step 2: ./system/GMM_DAE/train_DAE.sh
...
for id in "${loop[@]}"; do
    ...
    python main_GMM_DAE.py --cfgfile "$config_filepath" SYSTEM.phase 'train_DAE' SYSTEM.device "cuda:0" SYSTEM.loop_index "$id"
done
conda deactivate