...
class FastAnoAE(nn.Module):
    def __init__(self, batch_size, channels=1):
        super(FastAnoAE, self).__init__()
        bn = None # batch normalization
        if batch_size == 1:
            bn = False 
        else:
            bn = True
        self.conv1 = nn.Conv3d(channels, 64, 3, 2, 1)
        ...
        self.deconv1 = nn.Sequential(
            ...
            nn.ConvTranspose3d(64 * 2, channels, (1, 2, 2), (1, 2, 2), (1, 0, 0)), 
            nn.Tanh()
        )
