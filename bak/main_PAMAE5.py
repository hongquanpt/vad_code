...
from bak.model.MNAD.PAMAEModel5 import PAMAEModel5
...
def train(cfg, device, logger, writer, checkpoint_dir_path):
    ...
    # ====================================
    # 4. load model
    pamae5 = PAMAEModel5(cfg, device, logger, writer)
    ...
    pamae5.train(train_dataloader, train_dataloader_kf, checkpoint_filepath, checkpoint_dir_path)
    return 1
...
def test(cfg, device, logger, writer, visualization_dir_path):
    ...
    pamae5.test(test_dataloader, label_list, checkpoint_filepath, sub_visualization_dir_path)
    return 0
...
if __name__ == '__main__':
    """
    python main_PAMAE5.py --phase 'train' --dataset 'ped2' SYSTEM.device "cuda:0"
    """
    main(net='PAMAE5')
